...
const profile_1 = __importDefault(require("./admin/profile"));
...
const booking_1 = __importDefault(require("./admin/booking"));
...
AdminApiEndpoints.use('/profile', authenticate_1.default, authenticate_1.isAdministrator, profile_1.default);
...
AdminApiEndpoints.use('/bookings', authenticate_1.default, authenticate_1.isAdministrator, booking_1.default);
