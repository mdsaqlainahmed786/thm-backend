...
exports.defaultAmenity = exports.AmenityCategory = void 0;
const mongoose_1 = __importStar(require("mongoose"));
var AmenityCategory;
(function (AmenityCategory) {
    AmenityCategory["OTHER"] = "Other Facilities";
    AmenityCategory["BATHROOM"] = "Bathroom";
    AmenityCategory["MEDIA_AND_ENTERTAINMENT"] = "Media and Entertainment";
    AmenityCategory["SAFETY_AND_SECURITY"] = "Safety and Security";
    AmenityCategory["BEDS_AND_BLANKET"] = "Beds and Blanket";
    AmenityCategory["CHILDCARE"] = "Childcare";
    AmenityCategory["ROOM_FEATURES"] = "Room Features";
    AmenityCategory["POPULAR_WITH_GUESTS"] = "Popular with Guests";
    AmenityCategory["HIGHLIGHTED_AMENITIES"] = "Highlighted Amenities";
    AmenityCategory["BASIC_FACILITIES"] = "Basic Facilities";
    AmenityCategory["TRANSFERS"] = "Transfers";
    AmenityCategory["FAMILY_AND_KIDS"] = "Family and kids";
    AmenityCategory["FOOD_AND_DRINKS"] = "Food and Drinks";
    AmenityCategory["PAYMENT_SERVICES"] = "Payment Services";
    AmenityCategory["HEALTH_AND_WELLNESS"] = "Health and wellness";
    AmenityCategory["ENTERTAINMENT"] = "Entertainment";
    AmenityCategory["MEDIA_AND_TECHNOLOGY"] = "Media and technology";
    AmenityCategory["GENERAL_SERVICES"] = "General Services";
    AmenityCategory["BEAUTY_AND_SPA"] = "Beauty and Spa";
    AmenityCategory["OUTDOOR_ACTIVITIES_AND_SPORTS"] = "Outdoor Activities and Sports";
    AmenityCategory["INDOOR_ACTIVITIES_AND_SPORTS"] = "Indoor Activities and Sports";
    AmenityCategory["COMMON_AREA"] = "Common Area";
    AmenityCategory["SHOPPING"] = "Shopping";
    AmenityCategory["BUSINESS_CENTER_AND_CONFERENCES"] = "Business Center and Conferences";
})(AmenityCategory || (exports.AmenityCategory = AmenityCategory = {}));
exports.defaultAmenity = [
    //Popular with Guests
