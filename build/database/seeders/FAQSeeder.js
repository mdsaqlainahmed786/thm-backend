...
const faqs = [
    //General 
    {
        question: `What is ${constants_1.AppConfig.APP_NAME}?`,
        answer: `${constants_1.AppConfig.APP_NAME} is a social media platform that allows users to share photos, videos, and Stories, connect with friends, and discover content from around the world.`,
        isPublished: true,
        type: "general",
    },
    {
        question: `How do I download the ${constants_1.AppConfig.APP_NAME} app?`,
        answer: `You can download the ${constants_1.AppConfig.APP_NAME} app from the Apple App Store (for iOS devices) or the Google Play Store (for Android devices). Simply search for "${constants_1.AppConfig.APP_NAME}" and click "Install."`,
        isPublished: true,
        type: "general",
    },
    {
        question: `Is ${constants_1.AppConfig.APP_NAME} free to use?`,
        answer: `Yes, ${constants_1.AppConfig.APP_NAME} is free for end users, but businesses will need to pay for certain features. It also offers in-app purchases for options like events and unlimited content posting`,
        isPublished: true,
        type: "general",
    },
    {
        question: `What types of content can I share on ${constants_1.AppConfig.APP_NAME}?`,
    ...
    {
        question: `How does the ${constants_1.AppConfig.APP_NAME} algorithm work?`,
        answer: `The ${constants_1.AppConfig.APP_NAME} algorithm prioritizes content based on user engagement, relationships, and recency. It aims to show users posts that are most relevant to them.`,
        isPublished: true,
        type: "general",
    },
    {
    ...
    {
        question: `How do I follow someone on ${constants_1.AppConfig.APP_NAME}?`,
    ...
    },
    {
        ...
        answer: `If you're having trouble logging in, check if you're using the correct email and password. If you forgot your password, click "Forgot password?" on the login page to reset it. If issues persist, visit ${constants_1.AppConfig.APP_NAME}'s Help Center for further assistance.`,
        isPublished: true,
        type: "general",
    },
    //Account 
    {
        question: `How do I create an account on ${constants_1.AppConfig.APP_NAME}?`,
    ...
    {
        question: `How can I make my ${constants_1.AppConfig.APP_NAME} account private?`,
    ...
    {
        question: `What are ${constants_1.AppConfig.APP_NAME}'s content guidelines?`,
        answer: `${constants_1.AppConfig.APP_NAME}’s content guidelines prohibit hate speech, nudity, graphic violence, and spam. Make sure your content adheres to these guidelines to avoid removal or account suspension.`,
        isPublished: true,
        type: "content",
    },
    {
        question: `What should I do if my content gets removed?`,
        answer: `If your content is removed, check ${constants_1.AppConfig.APP_NAME}'s community guidelines to understand why. You can appeal the decision by following the instructions provided in the notification you received.`,
        isPublished: true,
        type: "content",
    },
    //Privacy
    {
        question: `What information does ${constants_1.AppConfig.APP_NAME} collect from me?`,
        answer: ` ${constants_1.AppConfig.APP_NAME} collects various data, including your profile information, posts, interactions, device information, and location data. This helps improve the app and personalize your experience.`,
        isPublished: true,
        type: "privacy",
    },
    {
    ...
    {
        question: `What should I do if someone is harassing me on ${constants_1.AppConfig.APP_NAME}?`,
    ...
    {
        question: `How can I delete my data from ${constants_1.AppConfig.APP_NAME}?`,
...
class FAQSeeder {
    shouldRun() {
        return __awaiter(this, void 0, void 0, function* () {
            const count = yield faq_model_1.default.countDocuments().exec();
            return count === 0;
        });
    }
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            return faq_model_1.default.create(faqs);
        });
    }
}
exports.default = FAQSeeder;
