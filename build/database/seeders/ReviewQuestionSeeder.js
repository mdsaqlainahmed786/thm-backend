...
const businessReviewQuestion_model_1 = __importDefault(require("../models/businessReviewQuestion.model"));
class ReviewQuestionSeeder {
    ...
    shouldRun() {
        return __awaiter(this, void 0, void 0, function* () {
            const count = yield businessReviewQuestion_model_1.default.countDocuments().exec();
            return count === 0;
        });
    }
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            const reviewQuestions = [
                {
                    ...
                    businessTypeID: [BusinessTypeSeeder_1.BusinessTypes[0]],
                    businessSubtypeID: [BusinessSubtypeSeeder_1.Hotes[0]],
                    order: 1,
                },
                {
                    icon: this.hostAddress + '/public/files/airport.png',
                ...
                //4 star
                {
                    ...
                    businessTypeID: [BusinessTypeSeeder_1.BusinessTypes[0]],
                    businessSubtypeID: [BusinessSubtypeSeeder_1.Hotes[1]],
                    order: 1,
                },
                {
                    icon: this.hostAddress + '/public/files/non-ac-room.png',
                ...
                //5 star
                {
                    ...
                    businessTypeID: [BusinessTypeSeeder_1.BusinessTypes[0]],
                    businessSubtypeID: [BusinessSubtypeSeeder_1.Hotes[2]],
                    order: 1,
                },
                {
                    icon: this.hostAddress + '/public/files/non-ac-room.png',
            ...
            const reviewQuestion = yield Promise.all(reviewQuestions.map((question) => __awaiter(this, void 0, void 0, function* () {
                ...
                const businessReviewQuestion = yield businessReviewQuestion_model_1.default.findOne({ businessTypeID: { $in: businessTypeID }, businessSubtypeID: { $in: businessSubtypeID }, question: question.question });
                if (!businessReviewQuestion) {
                    const businessReviewQuestion = new businessReviewQuestion_model_1.default();
                    ...
                    yield businessReviewQuestion.save();
                }
                return question;
            })));
...
exports.default = ReviewQuestionSeeder;
