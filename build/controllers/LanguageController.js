...
const language_1 = __importDefault(require("../provider/language"));
const FETCHED = "Languages fetched.";
const index = (request, response, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        return response.send((0, response_1.httpOk)(language_1.default, FETCHED));
    }
    catch (error) {
