    ...
    io.on("connection", (socket) => {
        ...
        socket.on(constants_1.SocketChannel.COLLAB_RESPONSE, (data) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (action === "accept") {
                    if (!((_b = post.collaborators) === null || _b === void 0 ? void 0 : _b.some((c) => c.toString() === userID.toString()))) {
        ...
        socket.on(constants_1.SocketChannel.COLLAB_UPDATE, (data) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!post)
                return;
            //@ts-ignore
            const targetUsers = [post.userID.toString(), ...(_a = post.collaborators) === null || _a === void 0 ? void 0 : _a.map(String)];
